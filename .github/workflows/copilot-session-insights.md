# gh-aw-metadata: {"schema_version":"v4","frontmatter_hash":"040112692ddb8b7f01d5e2d7803a5e78461a59faac3cd1dd1edc08ccc9b60007","body_hash":"4f73aecce638e6387674bed8b43411cb6762dae589c836f24629d68d1134c76c","strict":true,"agent_id":"claude","engine_versions":{"claude":"2.1.168"}}
...
env:
  ...
  OTEL_SERVICE_NAME: gh-aw.copilot-session-insights
  OTEL_RESOURCE_ATTRIBUTES: 'gh-aw.workflow.name=Copilot Session Insights,gh-aw.repository=${{ github.repository }},gh-aw.run.id=${{ github.run_id }},github.run_id=${{ github.run_id }},gh-aw.engine.id=claude'
...
jobs:
  activation:
    ...
    steps:
      ...
      - name: Setup Scripts
        ...
        env:
          GH_AW_SETUP_WORKFLOW_NAME: "Copilot Session Insights"
          GH_AW_CURRENT_WORKFLOW_REF: ${{ github.repository }}/.github/workflows/copilot-session-insights.lock.yml@${{ github.ref }}
          GH_AW_INFO_VERSION: "2.1.168"
      ...
      - name: Generate agentic run info
        ...
        env:
          ...
          GH_AW_INFO_VERSION: "2.1.168"
          GH_AW_INFO_AGENT_VERSION: "2.1.168"
          GH_AW_INFO_WORKFLOW_NAME: "Copilot Session Insights"
          GH_AW_INFO_EXPERIMENTAL: "false"
          GH_AW_INFO_SUPPORTS_TOOLS_ALLOWLIST: "true"
          GH_AW_INFO_STAGED: "false"
          GH_AW_INFO_ALLOWED_DOMAINS: '["*.grafana.net","*.sentry.io","defaults","github","python"]'
      ...
      - name: Create prompt with built-in context
        ...
        run: |
          ...
          {
          cat << 'GH_AW_PROMPT_9cc4812bf6819465_EOF'
          <system>
          GH_AW_PROMPT_9cc4812bf6819465_EOF
          ...
          {{#runtime-import .github/workflows/shared/session-analysis-charts.md}}
          {{#runtime-import .github/workflows/shared/session-analysis-strategies.md}}
    ...
    steps:
      ...
      - name: Generate Safe Outputs Config
        ...
        run: |
          ...
          cat > "${RUNNER_TEMP}/gh-aw/safeoutputs/config.json" << 'GH_AW_SAFE_OUTPUTS_CONFIG_3183de4ebed8ee4a_EOF'
          {"create_discussion":{"category":"audits","close_older_discussions":true,"expires":24,"fallback_to_issue":true,"max":1,"title_prefix":"[copilot-session-insights] "},"create_report_incomplete_issue":{},"missing_data":{},"missing_tool":{},"noop":{"max":1,"report-as-issue":"true"},"push_repo_memory":{"memories":[{"dir":"/tmp/gh-aw/repo-memory/default","id":"default","max_file_count":100,"max_file_size":102400,"max_patch_size":10240}]},"report_incomplete":{},"upload_asset":{"allowed-exts":[".png",".jpg",".jpeg",".svg"],"branch":"assets/${GITHUB_WORKFLOW}","max":5,"max-size":10240}}
          GH_AW_SAFE_OUTPUTS_CONFIG_3183de4ebed8ee4a_EOF
      ...
      - name: Start MCP Gateway
        ...
        run: |
          ...
          cat << GH_AW_MCP_CONFIG_20595fcf141de993_EOF | "$GH_AW_NODE" "${RUNNER_TEMP}/gh-aw/actions/start_mcp_gateway.cjs"
          {
            "mcpServers": {
              "safeoutputs": {
                "type": "http",
          ...
          GH_AW_MCP_CONFIG_20595fcf141de993_EOF
      ...
      - name: Execute Claude Code CLI
        ...
        env:
          ...
          GH_AW_MODEL_AGENT_CLAUDE: ${{ vars.GH_AW_MODEL_AGENT_CLAUDE || vars.GH_AW_DEFAULT_MODEL_CLAUDE || '' }}
          GH_AW_PHASE: agent
          GH_AW_PROMPT: /tmp/gh-aw/aw-prompts/prompt.txt
          GH_AW_SAFE_OUTPUTS: ${{ steps.set-runtime-paths.outputs.GH_AW_SAFE_OUTPUTS }}
      ...
      - name: Ingest agent output
        ...
        env:
          GH_AW_SAFE_OUTPUTS: ${{ steps.set-runtime-paths.outputs.GH_AW_SAFE_OUTPUTS }}
          GH_AW_ALLOWED_DOMAINS: "*.githubusercontent.com,*.grafana.net,*.pythonhosted.org,*.sentry.io,anaconda.org,anthropic.com,api.anthropic.com,api.github.com,api.snapcraft.io,archive.ubuntu.com,azure.archive.ubuntu.com,binstar.org,bootstrap.pypa.io,cdn.playwright.dev,codeload.github.com,conda.anaconda.org,conda.binstar.org,crl.geotrust.com,crl.globalsign.com,crl.identrust.com,crl.sectigo.com,crl.thawte.com,crl.usertrust.com,crl.verisign.com,crl3.digicert.com,crl4.digicert.com,crls.ssl.com,docs.github.com,files.pythonhosted.org,ghcr.io,github-cloud.githubusercontent.com,github-cloud.s3.amazonaws.com,github.blog,github.com,github.githubassets.com,host.docker.internal,json-schema.org,json.schemastore.org,keyserver.ubuntu.com,lfs.github.com,objects.githubusercontent.com,ocsp.digicert.com,ocsp.geotrust.com,ocsp.globalsign.com,ocsp.identrust.com,ocsp.sectigo.com,ocsp.ssl.com,ocsp.thawte.com,ocsp.usertrust.com,ocsp.verisign.com,packagecloud.io,packages.cloud.google.com,packages.microsoft.com,patch-diff.githubusercontent.com,pip.pypa.io,playwright.download.prss.microsoft.com,ppa.launchpad.net,pypi.org,pypi.python.org,raw.githubusercontent.com,registry.npmjs.org,repo.anaconda.com,repo.continuum.io,s.symcb.com,s.symcd.com,security.ubuntu.com,sentry.io,statsig.anthropic.com,ts-crl.ws.symantec.com,ts-ocsp.ws.symantec.com,www.googleapis.com"
          GITHUB_SERVER_URL: ${{ github.server_url }}
    ...
    steps:
      ...
      - name: Process no-op messages
        ...
        env:
          ...
          GH_AW_NOOP_MAX: "1"
          GH_AW_WORKFLOW_NAME: "Copilot Session Insights"
          GH_AW_WORKFLOW_SOURCE_URL: "${{ github.server_url }}/${{ github.repository }}/blob/${{ github.ref_name }}/.github/workflows/copilot-session-insights.md"
          GH_AW_RUN_URL: ${{ github.server_url }}/${{ github.repository }}/actions/runs/${{ github.run_id }}
    ...
    steps:
      ...
      - name: Execute Claude Code CLI
        ...
        env:
          ...
          DISABLE_TELEMETRY: 1
          GH_AW_MAX_TURNS: ${{ vars.GH_AW_DEFAULT_MAX_TURNS || '' }}
          GH_AW_MODEL_DETECTION_CLAUDE: ${{ vars.GH_AW_MODEL_DETECTION_CLAUDE || vars.GH_AW_DEFAULT_MODEL_CLAUDE || '' }}
  ...
  push_repo_memory:
    ...
    permissions:
      contents: write
    concurrency:
      group: "push-repo-memory-${{ github.repository }}|memory/session-insights"
      cancel-in-progress: false
    outputs:
